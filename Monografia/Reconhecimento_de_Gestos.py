...
for f in xrange( frames_total ):
	...
	if(maiorProbabilidade_Index == 0 and maiorProbabilidade == None): nomeGesto = ''
	if(maiorProbabilidade_Index == 0 and maiorProbabilidade != None): nomeGesto = 'Passo para Direita/Step Right'
